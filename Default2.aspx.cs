            ...
            get
            {
                ...
                using (Bitmap bmp = new Bitmap(1, 1, PixelFormat.Format32bppArgb))
                {
                    using (Graphics g = Graphics.FromImage(bmp))
                    {
                        ...
                        _sizeBarCodeValue = g.MeasureString(BarCodeValue, new Font("3 of 9 Barcode", _barCodeFontSize));
        ...
        public Bitmap CreateWebForm(Stream ms, ImageFormat imageFormat)
        {
            ...
            using (Bitmap bmp = this.BlankBackImage)
            {
                ...
                using (Graphics g = Graphics.FromImage(bmp))
                {
                    ...
                    ////Draw The Bar Value 
                    g.DrawString(_barCodeValue, new Font("3 of 9 Barcode", _barCodeFontSize), new SolidBrush(Color.Black),
